// VERSIÓN ORIGINAL CON BUGS (solo para demostrar que las pruebas los detectan)
...
const HyperloopService = {
    bookSeat: (podId, requestedDestination) => {
        ...
        if (pod.passengers > pod.capacity) { // BUG 1
            throw new Error('Cápsula llena');
        }

        pod.destination = requestedDestination; // BUG 2
